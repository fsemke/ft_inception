...
if [ -f "/var/www/wordpress/wp-config.php" ]; then
	...
	wp core install --url="fsemke.42.fr" --title="Welcome to the website from florian" --admin_user="$WP_ADMIN" --admin_password="$WP_ADMIN_PW" --admin_email="$WP_ADMIN@adminmail.de" --allow-root
